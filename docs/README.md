...
| **Reference** | [`reference/`](reference/) | Deep manuals: ruleset writing / syntax / iterating (the trio), Prolog, planner internals, component system, build setup, challenge-play protocol |

...
public:
    ...
    virtual HtnOperator *AddOperator(shared_ptr<HtnTerm> head,
                                     const vector<shared_ptr<HtnTerm>> &addList,
                                     const vector<shared_ptr<HtnTerm>> &deleteList,
                                     bool hidden = false,
                                     const vector<shared_ptr<HtnTerm>> &increaseList = vector<shared_ptr<HtnTerm>>(),
                                     const vector<shared_ptr<HtnTerm>> &decreaseList = vector<shared_ptr<HtnTerm>>()) = 0;
